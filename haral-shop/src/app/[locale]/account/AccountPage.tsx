        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm">
          ...
          >
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full rounded-xl bg-emerald-600 py-3 text-sm font-semibold text-white hover:bg-emerald-700 transition-colors disabled:opacity-60"
            >
              {loading ? tCommon("loading") : isRegister ? t("registerTitle") : t("loginTitle")}
            </button>
          </form>
